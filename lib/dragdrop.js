...
Dragdrop = (function(_super) {
  ...
  Dragdrop.prototype._initOptions = function(e) {
    if (this.opts.cursorPosition === 'center') {
      this.originalOffset = {
        top: -this.helper.outerHeight(true) / 2 + this.opts.cursorOffset.top,
        left: -this.helper.outerWidth(true) / 2 + this.opts.cursorOffset.left
      };
    }
    if (this.opts.cursorPosition === 'cornor') {
      this.originalOffset = {
        top: this.opts.cursorOffset.top,
        left: this.opts.cursorOffset.left
      };
    }
    if (this.opts.cursorPosition === 'auto') {
      this.originalOffset = {
        top: this.dragging.offset().top - e.pageY + this.opts.cursorOffset.top,
        left: this.dragging.offset().left - e.pageX + this.opts.cursorOffset.left
      };
    }
    return this.helper.css({
      visibility: 'visible',
