  ...
  Dragdrop.prototype._bind = function() {
    return this.el.on('mousedown.simple-dragdrop', this.opts.draggable, (function(_this) {
      return function(e) {
        ...
        _this.trigger('dragstart', _this.dragging);
        ...
        _this.el.on('mouseenter.simple-dragdrop', _this.opts.droppable, function(e) {
          var $target;
          if (!_this.dragging) {
            return;
          }
        ...
        return _this.el.on('mouseleave.simple-dragdrop', _this.opts.droppable, function(e) {
          var $target;
          if (!_this.dragging) {
            return;
          }
