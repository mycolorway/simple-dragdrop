...
Dragdrop = (function(_super) {
    ...
    return this.el.on('mousedown.simple-dragdrop', this.opts.draggable, (function(_this) {
      return function(e) {
        ...
        return _this.el.on('mouseenter.simple-dragdrop', _this.opts.droppable, function(e) {
          ...
          $target = $(e.currentTarget);
          _this.trigger('dragenter', [_this.dragging, $target]);
  ...
  Dragdrop.prototype._dragStart = function(e) {
    ...
    switch (cursorPosition) {
      case 'center':
        this.originalOffset = {
          top: -this.helper.outerHeight(true) / 2 - this.dragging.offset().top,
          left: -this.helper.outerWidth(true) / 2 - this.dragging.offset().left
        };
        break;
      case 'corner':
        this.originalOffset = {
    ...
    this.originalOffset.top += this.dragging.position().top + this.opts.cursorOffset.top;
    this.originalOffset.left += this.dragging.position().left + this.opts.cursorOffset.left;
    return this.helper.css({
      visibility: 'visible',
  ...
  Dragdrop.prototype._dragEnd = function() {
    ...
    return this.el.off('mouseenter.simple-dragdrop');
  };
