...
Dragdrop = (function(superClass) {
  ...
  Dragdrop.prototype._dragStart = function($target, pos) {
    ...
    this.trigger('dragstart', [this.dragging, this.helper, this.placeholder]);
    ...
    $(document).one('mouseup.simple-dragdrop', (function(_this) {
      return function(e) {
        ...
        _this.trigger('before-dragend', $dragging);
        _this._dragEnd();
        return _this.trigger('dragend', $dragging);
      };
    })(this));
    $(document).one('mouseup.simple-dragdrop', this.opts.droppable, (function(_this) {
      return function(e) {
        ...
        $dragging = $(_this.dragging);
        _this.trigger('before-dragend', $dragging);
        _this.trigger('before-drop', [$dragging, $target]);
        _this._dragEnd();
        _this.trigger('dragend', $dragging);
        return _this.trigger('drop', [$dragging, $target]);
      };
    })(this));
